...
class PostForm(FlaskForm):
    ...
    city = StringField('City',widget=widgets.HiddenInput(), validators=[Length(max=100)])

    state = StringField('State',widget=widgets.HiddenInput(), validators=[Length(min=0, max=100)])

    country = StringField('Country',widget=widgets.HiddenInput(), validators=[Length(min=0, max=100)])
